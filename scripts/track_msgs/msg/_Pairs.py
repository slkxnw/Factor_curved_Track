...
"""autogenerated by genpy from track_msgs/Pairs.msg. Do not edit."""
import codecs
import sys
...
uint32 stride  # stride of given dimension"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.dets.layout.dim)
      buff.write(_struct_I.pack(length))
      for val1 in self.dets.layout.dim:
        _x = val1.label
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.dets.layout.dim.append(val1)
      start = end
      end += 4
      (self.dets.layout.data_offset,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sH'%length
      ...
      for i in range(0, length):
        ...
        (_x.size, _x.stride,) = _get_struct_2I().unpack(str[start:end])
        self.trk.layout.dim.append(val1)
      start = end
      end += 4
      (self.trk.layout.data_offset,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sH'%length
