...
"""autogenerated by genpy from track_msgs/Det_pubRequest.msg. Do not edit."""
import codecs
import sys
...
class Det_pubRequest(genpy.Message):
  _md5sum = "b4991ef15b2d061abe8797f020d7d387"
  _type = "track_msgs/Det_pubRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """uint16 frame_id
"""
  __slots__ = ['frame_id']
  _slot_types = ['uint16']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Det_pubRequest, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.frame_id,) = _get_struct_H().unpack(str[start:end])
      return self
...
def _get_struct_H():
    ...
    return _struct_H
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from track_msgs/Det_pubResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class Det_pubResponse(genpy.Message):
  _md5sum = "ae0877e83d0f6e6a6d715e503e82894d"
  _type = "track_msgs/Det_pubResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Det_pubResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_f():
    ...
    return _struct_f
class Det_pub(object):
  _type          = 'track_msgs/Det_pub'
  _md5sum = '990f8860e61eeb05ec29bf363d6fb3f9'
  _request_class  = Det_pubRequest
  _response_class = Det_pubResponse
