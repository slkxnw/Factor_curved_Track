...
class Det_pubRequest(genpy.Message):
  _md5sum = "75e2b2ebc8c57ca41516edbe78de571b"
  _type = "track_msgs/Det_pubRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """uint8 frame_id
"""
  __slots__ = ['frame_id']
  _slot_types = ['uint8']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.frame_id,) = _get_struct_B().unpack(str[start:end])
      return self
...
class Det_pub(object):
  ...
  _md5sum = 'c1d8c1f6bf165a6af368cd72f2d7b60a'
